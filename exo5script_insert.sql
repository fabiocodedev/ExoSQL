...
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (1, 'Mathe', 'Siddon', '1975-01-22', '2042-01-22', 'Box, The');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (2, 'Aloysius', 'Ockenden', '1959-08-02', '1991-08-02', 'Destiny in Space');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (3, 'Kingston', 'Jeschner', '1943-08-21', '1977-08-21', 'Poseidon Adventure, The');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (4, 'Josias', 'Lum', '1975-06-28', '1999-06-28', 'American Splendor');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (5, 'Dion', 'Leuchars', '1916-06-27', '1999-06-27', 'Used Cars');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (6, 'Joyous', 'Mapplethorpe', '1943-06-24', '1965-06-24', 'Predator 2');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (7, 'Justen', 'Kiffe', '1924-02-15', '2004-02-15', 'Show Boat');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (8, 'Ilysa', 'Nicolson', '1955-03-02', '1977-03-02', 'Necessities of Life, The (Ce qu''il faut pour vivre)');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (9, 'Emogene', 'Eakly', '1967-04-17', null, 'Rapid Fire');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (10, 'Berti', 'Sillett', '1949-01-05', null, 'Captives');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (11, 'Pearle', 'Bravington', '1901-10-23', null, 'Grindhouse');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (12, 'Danika', 'Covely', '1963-09-22', '2024-09-22', 'Zero Kelvin (Kjærlighetens kjøtere)');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (13, 'Ardith', 'Lear', '1922-05-10', '2006-05-10', 'Running on Empty');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (14, 'Jerald', 'Hallawell', '1977-06-14', null, 'Skins');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (15, 'Hadria', 'Buttwell', '1917-08-21', null, 'Land of the Blind');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (16, 'Vaclav', 'Morillas', '1936-05-19', null, 'Out in the Dark');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (17, 'Heddi', 'Itzkovsky', '1932-10-08', '1980-10-08', 'Sliding Doors');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (18, 'Simona', 'MacKettrick', '1919-09-24', '1952-09-24', 'Evil Toons');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (19, 'Blair', 'Bossingham', '1970-12-02', '2010-12-02', 'Big Boss, The (Fists of Fury) (Tang shan da xiong)');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (20, 'Carlynne', 'Ceyssen', '1924-04-19', '1989-04-19', 'Hustler, The');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (21, 'Eula', 'Giacovelli', '1923-02-28', '1977-02-28', 'The Facts of Murder');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (22, 'Brad', 'Tift', '1933-06-14', null, 'Thick-Walled Room, The (Kabe atsuki heya)');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (23, 'Barty', 'Nunan', '1909-10-20', '1975-10-20', 'After Life (Wandafuru raifu)');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (24, 'Urson', 'Persicke', '1949-09-15', null, 'Little Monsters');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (25, 'Jules', 'Orable', '1958-10-13', '1995-10-13', 'Don''t Blink');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (26, 'Ronnie', 'Trewinnard', '1929-12-21', '1979-12-21', 'Changing Lanes');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (27, 'Verne', 'Axe', '1924-11-16', null, 'Night of the Demons');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (28, 'Addison', 'Farquharson', '1988-11-23', '2039-11-23', 'Highball');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (29, 'Ashely', 'Benzie', '1903-05-30', null, 'Oscar and Lucinda (a.k.a. Oscar & Lucinda)');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (30, 'Granger', 'Abramof', '1960-06-13', '1996-06-13', 'Crisis (Kris)');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (31, 'Deonne', 'Corkan', '1972-01-21', '2030-01-21', 'Schultze Gets the Blues');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (32, 'Georgeanna', 'Piatkowski', '1983-02-14', '2024-02-14', 'Faster');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (33, 'Clementine', 'Elward', '1924-10-28', null, 'Perfect');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (34, 'Faythe', 'Giles', '1901-09-12', null, 'Death of a Salesman');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (35, 'Naomi', 'Haysman', '1909-12-28', '1979-12-28', 'Missing Star, The (La stella che non c''è)');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (36, 'Daryl', 'Margetson', '1976-08-31', '2033-08-31', 'In Your Eyes');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (37, 'Gus', 'Esseby', '1920-06-09', '1968-06-09', 'Everybody''s All-American');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (38, 'Lissie', 'Strowlger', '1920-02-06', '1975-02-06', 'Raspberry Boat Refugee');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (39, 'Arch', 'Bellord', '1928-06-26', '1995-06-26', 'Such Good Friends');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (40, 'Cariotta', 'McGlaughn', '1941-03-28', '1981-03-28', 'Retro Puppet Master (Puppet Master 7)');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (41, 'Portie', 'Garling', '1973-07-29', '2039-07-29', 'North Beach');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (42, 'Kori', 'Raitie', '1978-07-19', '2000-07-19', 'Pusher');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (43, 'Mallorie', 'Ramberg', '1911-08-26', '1964-08-26', 'Ninja: Shadow of a Tear');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (44, 'Rockwell', 'Asple', '1981-07-05', '2030-07-05', 'Bugs Bunny / Road Runner Movie, The (a.k.a. The Great American Chase)');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (45, 'Cynthia', 'Portingale', '1980-08-25', null, 'From the Life of the Marionettes (Aus dem Leben der Marionetten) ');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (46, 'Holly', 'Christy', '1956-04-21', '2028-04-21', 'Salvador');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (47, 'Persis', 'Sacks', '1964-04-04', '1992-04-04', 'Fool''s Gold');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (48, 'Minda', 'Sherborn', '1975-08-19 ', null, 'Screaming Skull, The');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (49, 'Euphemia', 'McCane', '1912-12-25', '1963-12-25', 'Monster in Paris, A (Un monstre à Paris)');
insert into auteurs (idauteur, prenom, nom, datenaiss, datedeces, bibliographie) values (50, 'Electra', 'Baylie', '1941-05-12', null, 'To Tulsa and Back: On Tour with J.J. Cale');
-- ------------------------------------------------------------------------------------------------------------------------------------------------

insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (1, 'Aibox', '6 Havey Alley', '67165', 'Wissembourg', 'France', '0698579482', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (2, 'Riffpedia', '034 Aberg Point', '71009', 'Mâcon', 'France', '0753632614', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (3, 'Brightdog', '7903 Daystar Junction', '95711', 'Roissy Charles-de-Gaulle', 'France', '0931410055', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (4, 'Eire', '952 Lerdahl Way', '78294', 'Croissy-sur-Seine', 'France', '0999431838', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (5, 'Dazzlesphere', '3464 Carberry Plaza', '91821', 'Longjumeau', 'France', '0972729421', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (6, 'Einti', '64451 Lukken Parkway', '91104', 'Corbeil-Essonnes', 'France', '0928225223', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (7, 'Ailane', '45 David Park', '91881', 'Massy', 'France', '0801456078', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (8, 'Edgepulse', '49 Rieder Drive', '67961', 'Strasbourg', 'France', '0846305278', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (9, 'Mynte', '2885 Meadow Valley Alley', '92787', 'Issy-les-Moulineaux', 'France', '0994575028', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (10, 'Dablist', '582 Dorton Park', '13155', 'Tarascon', 'France', '0940747264', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (11, 'Yambee', '79590 Scofield Avenue', '21040', 'Dijon', 'France', '0963759485', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (12, 'Ailane', '981 Sutteridge Court', '41904', 'Blois', 'France', '0823882898', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (13, 'Lajo', '02374 Blue Bill Park Trail', '76177', 'Rouen', 'France', '0821510707', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (14, 'Realpoint', '53 Grasskamp Center', '92980', 'Paris La Défense', 'France', '0914383071', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (15, 'Layo', '58 Menomonie Court', '04104', 'Manosque', 'France', '0769867351', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (16, 'Wordify', '6029 Nobel Parkway', '76086', 'Le Havre', 'France', '0724070584', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (17, 'Thoughtstorm', '71 Riverside Alley', '75609', 'Paris 12', 'France', '0722893042', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (18, 'Wordware', '53799 Sundown Hill', '47211', 'Marmande', 'France', '0703961930', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (19, 'Cogidoo', '646 Green Crossing', '75929', 'Paris 19', 'France', '0875524470', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (20, 'Jayo', '63438 Ilene Road', '74999', 'Annecy', 'France', '0880742857', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (21, 'Dabtype', '3094 Luster Way', '57052', 'Metz', 'France', '0969599992', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (22, 'Fatz', '48 Nelson Plaza', '92660', 'Boulogne-Billancourt', 'France', '0960333419', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (23, 'Feednation', '9 Del Sol Terrace', '35203', 'Rennes', 'France', '0921167297', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (24, 'Abatz', '333 Summit Pass', '61004', 'Alençon', 'France', '0624363053', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (25, 'Minyx', '950 Park Meadow Junction', '44004', 'Nantes', 'France', '0908800618', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (26, 'Jabbercube', '5 Birchwood Court', '13399', 'Marseille', 'France', '0896407019', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (27, 'Lajo', '3 Westport Avenue', '64044', 'Pau', 'France', '0872264570', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (28, 'Zava', '6 Carpenter Avenue', '34964', 'Montpellier', 'France', '0967433738', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (29, 'Edgeblab', '6140 Northport Parkway', '21030', 'Dijon', 'France', '0942296248', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (30, 'Livetube', '7 Stone Corner Place', '44200', 'Nantes', 'France', '0881612742', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (31, 'Youfeed', '37048 Hanover Way', '13281', 'Marseille', 'France', '0996036106', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (32, 'Flashdog', '99691 Lawn Hill', '94598', 'Rungis', 'France', '0966289026', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (33, 'Skyndu', '580 Mendota Plaza', '76059', 'Le Havre', 'France', '0938298474', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (34, 'Zoombeat', '6602 Maple Circle', '13393', 'Marseille', 'France', '0779005993', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (35, 'Feednation', '1 Northview Hill', '62259', 'Hénin-Beaumont', 'France', '0970192319', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (36, 'Fivechat', '8 Kennedy Place', '35047', 'Rennes', 'France', '0904623203', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (37, 'Tagpad', '97 Ohio Pass', '57954', 'Montigny-lès-Metz', 'France', '0776034799', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (38, 'Demivee', '70842 Lien Court', '89204', 'Avallon', 'France', '0971115407', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (39, 'Quimba', '2 Miller Crossing', '92691', 'Levallois-Perret', 'France', '0581804922', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (40, 'Flashset', '7 Porter Park', '38164', 'Saint-Marcellin', 'France', '0996682148', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (41, 'Skyble', '23 Chive Way', '94234', 'Cachan', 'France', '0851041042', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (42, 'Trudeo', '414 Jay Park', '69212', 'Lyon', 'France', '0853657701', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (43, 'Trudoo', '9615 Fulton Terrace', '92169', 'Antony', 'France', '0919616529', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (44, 'Oyope', '46 Macpherson Pass', '17104', 'Saintes', 'France', '0918155165', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (45, 'Zoonoodle', '06 Northridge Trail', '76040', 'Rouen', 'France', '0718953724', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (46, 'Yata', '1425 Starling Circle', '77404', 'Lagny-sur-Marne', 'France', '0860090124', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (47, 'Topicstorm', '572 Sunnyside Center', '74009', 'Annecy', 'France', '0887802474', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (48, 'LiveZ', '37 Crescent Oaks Crossing', '77109', 'Meaux', 'France', '0987589172', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (49, 'Quimba', '65647 Raven Plaza', '13674', 'Aubagne', 'France', '0813416918', 'error: no implicit conversion of Fixnum into String');
insert into editeurs (idediteur, nom, adresse, code, ville, pays, telephone, fax) values (50, 'Trilia', '5 Mayer Parkway', '17314', 'Rochefort', 'France', '0625475324', 'error: no implicit conversion of Fixnum into String');
-- --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
insert into livres (idlivre, ISBN, titre, nbpages, dateparu, prix, idediteur, idauteur) values (91, '866409364-4', 'Six in Paris (Paris vu par...)', 286, '1974-10-02 13:09:15', 51, 10, 2);
insert into livres (idlivre, ISBN, titre, nbpages, dateparu, prix, idediteur, idauteur) values (92, '922747928-7', 'Eden', 120, '1976-06-15 17:06:36', 44, 1, 34);
insert into livres (idlivre, ISBN, titre, nbpages, dateparu, prix, idediteur, idauteur) values (93, '425086057-4', 'Ted Bundy', 498, '1928-12-24 03:36:46', 60, 39, 14);
insert into livres (idlivre, ISBN, titre, nbpages, dateparu, prix, idediteur, idauteur) values (94, '298413916-X', 'Two if by Sea', 322, '1990-12-09 11:24:18', 44, 42, 18);
insert into livres (idlivre, ISBN, titre, nbpages, dateparu, prix, idediteur, idauteur) values (95, '368269919-8', 'Edvard Munch', 309, '1956-01-04 03:31:08', 44, 48, 39);
insert into livres (idlivre, ISBN, titre, nbpages, dateparu, prix, idediteur, idauteur) values (96, '624351005-0', 'Comanche Station', 329, '1961-05-14 12:56:01', 41, 12, 30);
insert into livres (idlivre, ISBN, titre, nbpages, dateparu, prix, idediteur, idauteur) values (97, '065075914-1', 'Actress, the Dollars and the Transylvanians, The (Artista, dolarii si Ardelenii)', 57, '1973-03-18 11:30:08', 78, 42, 44);
insert into livres (idlivre, ISBN, titre, nbpages, dateparu, prix, idediteur, idauteur) values (98, '534396288-2', 'Week-End at the Waldorf', 392, '1975-11-27 21:41:24', 45, 8, 6);
insert into livres (idlivre, ISBN, titre, nbpages, dateparu, prix, idediteur, idauteur) values (99, '392181970-9', 'Talk of the Town, The', 264, '1948-01-17 22:33:25', 75, 2, 40);
insert into livres (idlivre, ISBN, titre, nbpages, dateparu, prix, idediteur, idauteur) values (100, '196703071-5', 'Felix the Cat: The Movie', 58, '1951-12-23 08:38:50', 46, 23, 31);
-- -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
